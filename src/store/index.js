...
export default new Vuex.Store({
  state: {
    ...
    app: {
      name: 'IEMS | Tools',
      version: '1.0',
      apiKey: 'eyJpdiI6InBaM1pVRVNEaUVNTmdzT04yWXlzWHc9PSIsInZhbHVlIjoiak5HcUMxdmwxTDBUNHBMdXV6L0tvQ2RWMHl2QlBFZEF4cm1GWndRT0RlZmc4MXpmTFMyNS9HYjVTeUE5UUUwSCIsIm1hYyI6IjdlZTE3MDZlMmMwYjI2ZWNhZTFhZjM1YzE1YjA3ZGNjYzM4NjAxZTdiZjg5YzdmYjdhMjEwMTk5ZmI3ZjllY2MifQ==',
