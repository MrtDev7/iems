<template>
  <div>
    ...
    >
      <div class="block block-rounded block-themed block-transparent mb-0">
        <div class="block-header bg-primary-dark">
          <h3 class="block-title">Edit Linodes</h3>
    ...
    >
      <div class="block block-rounded block-themed block-transparent mb-0">
        <div class="block-header bg-primary-dark">
          <h3 class="block-title">create new linode</h3>
          <div class="block-options">
            <button
              type="button"
              class="btn-block-option"
...
export default {
  ...
  methods: {
    getAccountFromList: function (linodeId) {
      this.accounts.forEach((e) => {
        if (e.id == linodeId) {
          ...
          this.name = e.name;
          this.maxDropletsPerRequest = e.maxDropletsPerRequest;
        }
      });
    },
    ...
    swalSuccess() {
      this.$swal("Success", "linode parameters updated perfectly!", "success");
    },
    ...
    createAccount: function () {
      ...
      const url =
        "http://cloud.iems.io/app/api/services/linode/create";
      this.$store.commit("pageLoader", { mode: "on" });
      const params = {
        rootPass: this.rootPass,
        token: this.token,
        maxDropletsPerRequest: this.maxDropletsPerRequest,
        name: this.name,
      };
    ...
    deleteAccountRequest: function (accountId) {
      ...
      const url = "http://cloud.iems.io/app/api/services/linode/" + accountId;
      this.$store.commit("pageLoader", { mode: "on" });
      axios
    ...
    sendUpdateAccountRequest: function (accountId) {
      ...
      const url =
        "http://cloud.iems.io/app/api/services/linode/update/" + accountId;
      this.$store.commit("pageLoader", { mode: "on" });
      const params = {
        rootPass: this.rootPass,
        token: this.token,
